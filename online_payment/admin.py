...
class TaxAdmin(admin.ModelAdmin):
	...
	list_display=('customer_id','account_number','tax_type_id','transaction_id','date','amount_paid')
...
##This is used by admin site to modify the display of Service Tax table    
class ServiceAdmin(admin.ModelAdmin):
	##Display format of fields	
	list_display=('customer_id','account_number','date')
...
admin.site.register(Service_Tax,ServiceAdmin)
